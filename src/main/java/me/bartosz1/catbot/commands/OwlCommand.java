...
public class OwlCommand implements Command {

    private final Request req = new Request.Builder().url("https://api.mythicalkitten.com/owls").build();
    private static final Logger LOGGER = LoggerFactory.getLogger(OwlCommand.class);
